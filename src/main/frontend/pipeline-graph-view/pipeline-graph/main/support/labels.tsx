...
export function BigLabel({
    ...
    if (isStageSelected(details.stage) || isStageChildSelected(details.stage, selectedStage)) {
 ...
 */
export function SmallLabel({ details, layout, isStageSelected }: SmallLabelProps) {
 ...
 */
export function SequentialContainerLabel({ details, layout }: SequentialContainerLabelProps) {

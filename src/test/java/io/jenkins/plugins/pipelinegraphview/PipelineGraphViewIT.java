...
@WithJenkins
@UsePlaywright(PipelineGraphViewIT.TestOptions.class)
class PipelineGraphViewIT {
    ...
    // mvn exec:java -e -D exec.mainClass="com.microsoft.playwright.CLI" -Dexec.classpathScope=test -Dexec.args="codegen http://localhost:8080/jenkins
    ...
    void doTheThing(Page p, JenkinsRule j) throws Exception {
        ...
        // maybe change to getUrl
        new PipelineJobPage(p, j, name)
            .goTo()
            .hasBuilds(1)
            .nthBuild(0)
            .hasStages(4)
    ...
    private static WorkflowRun setupJenkins(Page p, JenkinsRule j, String name, String jenkinsFile) {
        ...
        CompletableFuture<Void> jenkinsSetup = CompletableFuture.runAsync(() -> new ManageApperanceJenkinsPage(p, j).goTo()
            .displayPipelineOnJobPage()
            .displayPipelineOnBuildPage()
            .addPipelineAsConsoleProvider()
            .save());
